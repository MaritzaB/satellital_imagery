...
def get_sst_data(year, month):
    '''
    Source: 'https://coastwatch.pfeg.noaa.gov/erddap/griddap/jplMURSST42mday.graph'
    '''
    src='https://coastwatch.pfeg.noaa.gov/erddap/griddap/jplMURSST42mday.geotif?sst'
    ...
    filename = f'{directory}/{year}{month}_MUR_SST.tif'
...
def get_wind_data(year, month, dist_surface=10):
    ...
    file_name = f'{directory}/{year}{month}_FNMOC_10m_Surface_Winds.nc'
    print(url)
    os.makedirs(directory, exist_ok=True)
